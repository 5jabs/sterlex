/**
 * Cloudflare R2 storage utilities for Sterlex document management.
 ...
 *   R2_BUCKET_NAME      — bucket name (default: "sterlex")
 */
...
const BUCKET = process.env.R2_BUCKET_NAME ?? "sterlex";
