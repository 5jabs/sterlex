...
export default function PrivacyDataPage() {
    ...
    const handleExportAccountData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "sterlex-account-export.json");
        } catch (error) {
    ...
    const handleExportChatData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "sterlex-chat-export.json");
        } catch (error) {
    ...
    const handleExportTabularReviewsData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "sterlex-tabular-reviews-export.json");
        } catch (error) {
