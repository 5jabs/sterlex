...
export function UserMessage({ content, files, workflow }: Props) {
    ...
    return (
        <div className="w-full flex justify-end">
            <div className="max-w-[92%] min-w-0 bg-gray-100 rounded-xl px-3 py-3 md:max-w-[80%] md:px-4">
                <p className="text-sm text-gray-900 break-words whitespace-pre-wrap">{content}</p>
                {(workflow || hasFiles) && (
