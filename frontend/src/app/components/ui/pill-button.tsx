...
type PillButtonTone = "black" | "white" | "burgundy" | "danger";
...
const toneClasses: Record<PillButtonTone, string> = {
    ...
    burgundy: "border-burgundy-500/35 bg-burgundy-600/90 text-white shadow-[0_3px_9px_rgba(110,31,45,0.14),inset_0_1px_0_rgba(255,255,255,0.28),inset_0_-1px_0_rgba(255,255,255,0.16),inset_0_-4px_9px_rgba(74,20,31,0.24)] backdrop-blur-xl hover:bg-burgundy-600 disabled:hover:bg-burgundy-600/90",
